...
ENT.Weapons = {
	...
	["M197"] = {
		class = "hvap_pod_aimed_m197",
		info = {
			ShootPos = Vector(58, 0, 0),
...
ENT.Sounds = {
	...
	RotorNear = "hvap/engine/air/helicopter/hc_2/rotor_close.wav", -- rotor_close
	RotorFar = "hvap/engine/air/helicopter/hc_2/rotor_far.wav", -- rotor_far
