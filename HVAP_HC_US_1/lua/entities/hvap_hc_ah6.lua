...
ENT.SpawnHeight = 1
ENT.PrintName = "AH-6 Little Bird"
...
ENT.Weapons = {
	["M134"] = {
		class = "hvap_pod_gun_m134", --hvap_pod_mg_m134
		info = {
			Pods = {
				Vector(40,40,30),
				Vector(40,-40,30),
			},
			Sequential = false,--fire separatley?		
			Ammo = 1500,--750 a195
			FireRate = 2600,--2000low 3000fixed 6000high
		}
	}
}
