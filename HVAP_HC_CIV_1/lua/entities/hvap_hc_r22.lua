...
ENT.Weight = 389--empty weight in kg 
ENT.FuselageHealth = 100 --idk make it non retarded, based off size and or armor
...
ENT.Engines = {
	{
		...
		info = {
			...
			engineHealth = 80, -- health of engine should be same as the engines BaseHealth
			BaseHealth = 80, -- base health of engine
			Power = 372,-- engine power in kW --x4 for single engine  93
