AddCSLuaFile("hvap_hc_500d.lua")

ENT.Base = "hvap_hc_base"
ENT.Type = "anim"
ENT.Author = "The_HAVOK"
ENT.Category = "HVAP Aircraft Civilian"
ENT.Spawnable = true
ENT.AdminSpawnable = true
ENT.SpawnHeight = 64
ENT.PrintName = "MD 500D"

ENT.Model = "models/military2/air/air_h500.mdl"
ENT.Weight = 493--empty weight in kg 
ENT.FuselageHealth = 192 --idk make it non retarded, based off size and or armor
ENT.Deatheffect = "500lb_air" -- effect created on death of vehicle
ENT.PlyDmgMult = 1.92 -- damage multiplier for pilot snipe
...
ENT.Engines = {
	{
		...
		info = {
			FirePos = Vector(-28,0,28),-- fire, relative to pos
			SmokePos = Vector(-32,0,0),-- smoke, relative to pos
			EffectPos = Vector(-10,0,0),-- exhaust, relative to pos
			SmokeEffect = "hvap_smoke_trail", -- smokes effect
			EngineEffect = "hvap_heatwave", -- exhaust effect
			engineHealth = 128, -- health of engine should be same as the engines BaseHealth
			BaseHealth = 128, -- base health of engine
			Power = 828,-- engine power in kW --x4 for single engine  207
