AddCSLuaFile("hvap_hc_206b_f.lua")
...
ENT.Engines = {
	{
		pos = Vector(-74,0,80),	
		radius = 40, -- max dist damage to engine to deal damage, closer means more dmg 
		info = {
			FirePos = Vector(-28,0,28),-- fire, relative to pos
			SmokePos = Vector(-32,0,0),-- smoke, relative to pos
			EffectPos = Vector(-5,0,28),-- exhaust, relative to pos
			...
			Power = 1680,-- engine power in kW --x4 for single engine  420
