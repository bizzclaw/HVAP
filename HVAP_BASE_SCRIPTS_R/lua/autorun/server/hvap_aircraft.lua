...
AddCSLuaFile("autorun/client/hvap_aircraft_dev.lua");

hvap.aircraft.cvars = {
	startSpeed = CreateConVar("hvap_air_startspeed", 4, {FCVAR_ARCHIVE, FCVAR_REPLICATED, FCVAR_NOTIFY}, "Aircraft Start Speed"),
	removetime = CreateConVar("hvap_air_removetime", 30, {FCVAR_ARCHIVE, FCVAR_REPLICATED, FCVAR_NOTIFY}, "Time To Remove Dead Vehicles"),
	...
	arcademode = CreateConVar("hvap_arcade_enabled", 0, {FCVAR_ARCHIVE, FCVAR_REPLICATED, FCVAR_NOTIFY}, "Enable Arcade Mode"),
