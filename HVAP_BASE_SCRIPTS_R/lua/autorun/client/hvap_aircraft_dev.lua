...
local cms={
	x=CreateClientConVar("hvap_cl_air_clmodel_line_x",0,true,false),
	y=CreateClientConVar("hvap_cl_air_clmodel_line_y",0,true,false),
	z=CreateClientConVar("hvap_cl_air_clmodel_line_z",0,true,false),
	model=CreateClientConVar("hvap_cl_air_clmodel_model","",true,false),
	b=CreateClientConVar("hvap_cl_air_showdevhelp",0,true,false)
}

local cm=NULL

concommand.Add("hvap_cl_air_clientsidemodel_create", function(p,c,a)
...
concommand.Add("hvap_cl_air_clientsidemodel_remove", function(p,c,a)
	if IsValid(cm) then cm:Remove() end
end)

concommand.Add("hvap_cl_air_clmodel_printvars", function(p,c,a)
	local s="Vector("..math.floor(cms.x:GetFloat()*100)/100 ..","..math.floor(cms.y:GetFloat()*100)/100 ..","..math.floor(cms.z:GetFloat()*100)/100 ..")"
	p:ChatPrint(s)
end)

hvap.hook("HUDPaint","hvap_cl_air_dev_draw", function()
	if IsValid(cm) then
