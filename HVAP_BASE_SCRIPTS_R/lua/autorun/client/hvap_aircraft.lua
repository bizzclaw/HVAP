...
if not game.SinglePlayer() then
	...
	CreateClientConVar("hvap_air_removetime", 30, true)
	...
	CreateClientConVar("hvap_arcade_enabled", 0, true)	
	...
	cvars.AddChangeCallback("hvap_air_removetime",onchange)
...
hvap.addMenuPanel(hvap.menu.tab, hvap.menu.category, hvap.menu.aircraft, function(panel, info)
	...
	--panel:CheckBox("Double Force","hvap_air_doubletick")

	panel:CheckBox("Enable Arcade Mode","hvap_arcade_enabled")		
	panel:CheckBox("Enable Third Person","hvap_thirdperson_enabled")		
	panel:CheckBox("Enable Tracers","hvap_tracers")
	panel:CheckBox("No Player Damage","hvap_noplydmg")	
	panel:CheckBox("Kick Players From Dead Aircraft","hvap_kickdeath")		
	...
	panel:AddControl("Slider", {
		Label="Time to remove dead aircraft",
		Type="float",
		Min=0,
		Max=600,
		Command="hvap_air_removetime",
	})	
