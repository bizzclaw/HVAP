AddCSLuaFile("hvap_pod_aimed_m2.lua")
...
ENT.CoolDown = 5.12//ammount taken from heat every sec
ENT.HeatMult = 10//ammount added per bullet fired  1000 threshold
ENT.HeatTime = 5//time it takes for unoverheat
ENT.Caliber = 12.5
ENT.Spread = 0.6144
ENT.SndPitch = 100
