AddCSLuaFile("hvap_pod_mg17.lua")
...
ENT.Sounds = {
	shoot = "hvap/gun/mg17_loop.wav", -- sound played when firing
	stop = "hvap/gun/mg17_end.wav", -- sound played when stop firing
