...
ENT.PrintName = "Base Ground Unit"
...
ENT.Aerodynamics = {
	...
	Movement = {
		...
		Up = Vector(-2, 0, -2) -- move aircraft for (forwards) (right) (up) whem moving up | 1,0,-2 |
	},
	Rail = Vector(8, 8, 8),-- 0,0,0
	RailRotor = 1, -- like Z rail but only active when moving and the rotor is turning
	AngleDrag = Vector(0.08, 0.08, 0.08),
}
