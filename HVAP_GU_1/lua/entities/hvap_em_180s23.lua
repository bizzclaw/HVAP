AddCSLuaFile("hvap_em_180s23.lua")
...
ENT.Camera = {
	model = "models/Killstr3aKs/WoT/Russian/object_261_gun.mdl",
	pos = Vector(0,0,64),
	offset = Vector(-1,0,0),
	viewPos = Vector(8, -23, 10),
	maxAng = Angle(2, 360, 0),--maxdown, max left
	minAng = Angle(-50, -360, 0),--maxup, max right
	seat = 1,
	rotseat = true,
	atchseat = true
}
...
ENT.WeaponAttachments = {
	radar1 = {
		model = "models/Killstr3aKs/WoT/Russian/object_261_turret.mdl",
		pos = Vector(0,0,16),
		restrictPitch = true
	}
}
